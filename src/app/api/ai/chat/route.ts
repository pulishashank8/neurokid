...
- Keep responses concise but helpful`
  ...
  if (apiError || !reply) {
    ...
    } else if (lastUserMessage.includes('fever') || lastUserMessage.includes('cold') || lastUserMessage.includes('sick') || lastUserMessage.includes('ill') || lastUserMessage.includes('suffering')) {
    ...
    } else if (lastUserMessage.includes('calm') || lastUserMessage.includes('relax') || lastUserMessage.includes('anxious') || lastUserMessage.includes('anxiety')) {
    ...
    } else if (lastUserMessage.includes('food') || lastUserMessage.includes('eat') || lastUserMessage.includes('picky')) {
    ...
    } else if (lastUserMessage.includes('communicate') || lastUserMessage.includes('talk') || lastUserMessage.includes('speak')) {
