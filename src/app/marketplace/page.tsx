...
const allProducts = [
    ...
    {
        id: 600,
        name: "Sensory Rainbow Stacking Ring",
        category: "Toys",
        price: "$18.00",
        rating: 4.8,
        reviews: "6k+",
        tag: "Colors",
        link: "https://www.amazon.com/s?k=rainbow+stacking+ring+toys",
        color: "from-red-400/20 to-yellow-400/20 text-red-600 dark:text-red-300",
        icon: Puzzle
    },
    {
        id: 601,
        name: "Marble Run Building Set",
        category: "Toys",
        price: "$30.00",
        rating: 4.7,
        reviews: "12k+",
        tag: "STEM",
        link: "https://www.amazon.com/s?k=marble+run+for+kids",
        color: "from-blue-400/20 to-purple-400/20 text-blue-600 dark:text-blue-300",
        icon: Puzzle
    },
    {
        id: 602,
        name: "Sensory Rice Bin Kit",
        category: "Toys",
        price: "$25.00",
        rating: 4.6,
        reviews: "3k+",
        tag: "Tactile",
        link: "https://www.amazon.com/s?k=sensory+rice+bin+kit",
        color: "from-amber-400/20 to-orange-400/20 text-amber-600 dark:text-amber-300",
        icon: Layers
    },
    {
        id: 603,
        name: "Light Up Spinning Top",
        category: "Toys",
        price: "$12.00",
        rating: 4.5,
        reviews: "8k+",
        link: "https://www.amazon.com/s?k=light+up+spinning+top",
        color: "from-pink-400/20 to-purple-400/20 text-pink-600 dark:text-pink-300",
        icon: Zap
    },
    {
        id: 604,
        name: "Stretchy String Sensory Toys",
        category: "Toys",
        price: "$8.00",
        rating: 4.6,
        reviews: "15k+",
        link: "https://www.amazon.com/s?k=stretchy+string+sensory+toys",
        color: "from-green-400/20 to-teal-400/20 text-green-600 dark:text-green-300",
        icon: Smile
    },
    {
        id: 605,
        name: "Spiky Sensory Balls Set",
        category: "Toys",
        price: "$10.00",
        rating: 4.7,
        reviews: "10k+",
        link: "https://www.amazon.com/s?k=spiky+sensory+balls",
        color: "from-orange-400/20 to-red-400/20 text-orange-600 dark:text-orange-300",
        icon: Smile
    },
    {
        id: 606,
        name: "Mesh & Marble Fidget Tubes",
        category: "Toys",
        price: "$8.00",
        rating: 4.5,
        reviews: "5k+",
        link: "https://www.amazon.com/s?k=mesh+marble+fidget+toy",
        color: "from-cyan-400/20 to-blue-400/20 text-cyan-600 dark:text-cyan-300",
        icon: Gamepad2
    },
    {
        id: 607,
        name: "Wooden Peg Puzzle Set",
        category: "Toys",
        price: "$15.00",
        rating: 4.8,
        reviews: "7k+",
        tag: "Educational",
        link: "https://www.amazon.com/s?k=wooden+peg+puzzle+toddler",
        color: "from-amber-500/20 to-yellow-500/20 text-amber-700 dark:text-amber-300",
        icon: Puzzle
    },
    {
        id: 608,
        name: "Finger Paint Set (Non-Toxic)",
        category: "Toys",
        price: "$15.00",
        rating: 4.6,
        reviews: "20k+",
        tag: "Creative",
        link: "https://www.amazon.com/s?k=finger+paint+for+kids+non+toxic",
        color: "from-red-500/20 to-blue-500/20 text-red-600 dark:text-red-300",
        icon: Smile
    },
    {
        id: 609,
        ...
        reviews: "25k+",
        tag: "Outdoor",
        link: "https://www.amazon.com/s?k=bubble+machine+for+kids",
        color: "from-sky-400/20 to-blue-400/20 text-sky-600 dark:text-sky-300",
        icon: Smile
    },
    // --- ADDITIONAL SENSORY ITEMS ---
    {
        id: 610,
        name: "Sensory Bean Bag Chair",
        category: "Sensory",
        price: "$50.00",
        rating: 4.6,
        reviews: "4k+",
        tag: "Seating",
        link: "https://www.amazon.com/s?k=sensory+bean+bag+chair+kids",
        color: "from-purple-400/20 to-indigo-400/20 text-purple-600 dark:text-purple-300",
        icon: Anchor
    },
    {
        id: 611,
        name: "Foot Roller Massage Bar",
        category: "Sensory",
        price: "$12.00",
        rating: 4.5,
        reviews: "3k+",
        link: "https://www.amazon.com/s?k=foot+roller+massage+bar",
        color: "from-green-400/20 to-emerald-400/20 text-green-600 dark:text-green-300",
        icon: Zap
    },
    {
        id: 612,
        name: "Vibrating Pillow",
        category: "Sensory",
        price: "$25.00",
        rating: 4.6,
        reviews: "2k+",
        tag: "Calming",
        link: "https://www.amazon.com/s?k=vibrating+pillow+sensory",
        color: "from-blue-400/20 to-indigo-400/20 text-blue-600 dark:text-blue-300",
        icon: Layers
    },
    {
        id: 613,
        name: "LED Fiber Optic Lamp",
        category: "Sensory",
        price: "$15.00",
        rating: 4.7,
        reviews: "8k+",
        tag: "Visual",
        link: "https://www.amazon.com/s?k=fiber+optic+lamp+for+kids",
        color: "from-fuchsia-400/20 to-pink-400/20 text-fuchsia-600 dark:text-fuchsia-300",
        icon: Zap
    },
    {
        id: 614,
        name: "Sensory Water Mat",
        category: "Sensory",
        price: "$15.00",
        rating: 4.6,
        reviews: "5k+",
        tag: "Tummy Time",
        link: "https://www.amazon.com/s?k=water+mat+sensory+baby",
        color: "from-cyan-400/20 to-teal-400/20 text-cyan-600 dark:text-cyan-300",
        icon: Smile
    },
    {
        id: 615,
        name: "Lava Lamp Classic",
        category: "Sensory",
        price: "$20.00",
        rating: 4.5,
        reviews: "12k+",
        tag: "Visual",
        link: "https://www.amazon.com/s?k=lava+lamp+for+kids",
        color: "from-red-400/20 to-orange-400/20 text-red-600 dark:text-red-300",
        icon: Zap
    },
    // --- ADDITIONAL CLOTHING ---
    {
        id: 620,
        name: "Sensory Friendly Onesie",
        category: "Clothing",
        price: "$25.00",
        rating: 4.7,
        reviews: "2k+",
        tag: "Babies",
        link: "https://www.amazon.com/s?k=sensory+friendly+baby+onesie",
        color: "from-pink-300/20 to-rose-300/20 text-pink-600 dark:text-pink-300",
        icon: Shirt
    },
    {
        id: 621,
        name: "Compression Gloves for Kids",
        category: "Clothing",
        price: "$15.00",
        rating: 4.5,
        reviews: "1k+",
        link: "https://www.amazon.com/s?k=compression+gloves+for+kids",
        color: "from-blue-300/20 to-indigo-300/20 text-blue-600 dark:text-blue-300",
        icon: Shirt
    },
    {
        id: 622,
        name: "Soft Headband Headphones",
        category: "Clothing",
        price: "$20.00",
        rating: 4.6,
        reviews: "8k+",
        tag: "Sleep",
        link: "https://www.amazon.com/s?k=headband+headphones+kids",
        color: "from-violet-300/20 to-purple-300/20 text-violet-600 dark:text-violet-300",
        icon: Headphones
    },
    {
        id: 623,
        name: "Cooling Vest for Kids",
        category: "Clothing",
        price: "$45.00",
        rating: 4.4,
        reviews: "500+",
        tag: "Summer",
        link: "https://www.amazon.com/s?k=cooling+vest+for+kids",
        color: "from-sky-300/20 to-cyan-300/20 text-sky-600 dark:text-sky-300",
        icon: Shirt
    },
    // --- ADDITIONAL EDUCATION ---
    {
        ...
        reviews: "15k+",
        tag: "Reading",
        link: "https://www.amazon.com/s?k=sight+words+flash+cards",
        color: "from-emerald-400/20 to-green-400/20 text-emerald-600 dark:text-emerald-300",
        icon: BookOpen
    },
    {
        id: 631,
        name: "Counting Bears with Cups",
        category: "Education",
        price: "$20.00",
        rating: 4.8,
        reviews: "10k+",
        tag: "Math",
        link: "https://www.amazon.com/s?k=counting+bears+with+cups",
        color: "from-yellow-400/20 to-orange-400/20 text-yellow-600 dark:text-yellow-300",
        icon: Puzzle
    },
    {
        id: 632,
        name: "Social Story Books Set",
        category: "Education",
        price: "$25.00",
        rating: 4.7,
        reviews: "3k+",
        tag: "Social",
        link: "https://www.amazon.com/s?k=social+story+books+autism",
        color: "from-blue-400/20 to-sky-400/20 text-blue-600 dark:text-blue-300",
        icon: BookOpen
    },
    {
        id: 633,
        name: "Quiet Time Activity Box",
        category: "Education",
        price: "$30.00",
        rating: 4.6,
        reviews: "2k+",
        link: "https://www.amazon.com/s?k=quiet+time+activity+box+kids",
        color: "from-purple-400/20 to-violet-400/20 text-purple-600 dark:text-purple-300",
        icon: Puzzle
    },
    {
        id: 634,
        name: "Alphabet Tracing Cards",
        category: "Education",
        price: "$12.00",
        rating: 4.7,
        reviews: "5k+",
        link: "https://www.amazon.com/s?k=alphabet+tracing+cards",
        color: "from-teal-400/20 to-emerald-400/20 text-teal-600 dark:text-teal-300",
        icon: Gamepad2
    },
    ...
    {
        id: 640,
        name: "Spill-Proof Sippy Cup",
        category: "Daily Living",
        price: "$12.00",
        rating: 4.7,
        reviews: "20k+",
        link: "https://www.amazon.com/s?k=spill+proof+sippy+cup",
        color: "from-green-400/20 to-teal-400/20 text-green-600 dark:text-green-300",
        icon: Utensils
    },
    {
        id: 641,
        name: "Picture Schedule Board",
        category: "Daily Living",
        price: "$20.00",
        rating: 4.6,
        reviews: "3k+",
        tag: "Routine",
        link: "https://www.amazon.com/s?k=picture+schedule+board+autism",
        color: "from-blue-400/20 to-indigo-400/20 text-blue-600 dark:text-blue-300",
        icon: Clipboard
    },
    {
        id: 642,
        name: "Reward Chart for Kids",
        category: "Daily Living",
        price: "$15.00",
        rating: 4.7,
        reviews: "8k+",
        tag: "Behavior",
        link: "https://www.amazon.com/s?k=reward+chart+for+kids",
        color: "from-yellow-400/20 to-amber-400/20 text-yellow-600 dark:text-yellow-300",
        icon: Smile
    },
    {
        id: 643,
        name: "Divided Dinner Plate",
        category: "Daily Living",
        price: "$18.00",
        rating: 4.5,
        reviews: "5k+",
        link: "https://www.amazon.com/s?k=divided+plates+for+kids",
        color: "from-orange-400/20 to-red-400/20 text-orange-600 dark:text-orange-300",
        icon: Utensils
    },
    {
        id: 644,
        name: "Hair Detangling Brush",
        category: "Daily Living",
        price: "$10.00",
        rating: 4.8,
        reviews: "30k+",
        link: "https://www.amazon.com/s?k=detangling+brush+for+kids",
        color: "from-pink-400/20 to-rose-400/20 text-pink-600 dark:text-pink-300",
        icon: Smile
    },
    // --- ADDITIONAL GIFTS ---
    {
        id: 650,
        name: "Autism Awareness Puzzle Jewelry",
        category: "Gifts",
        price: "$15.00",
        rating: 4.6,
        reviews: "2k+",
        link: "https://www.amazon.com/s?k=autism+awareness+jewelry",
        color: "from-blue-400/20 to-purple-400/20 text-blue-600 dark:text-blue-300",
        icon: Heart
    },
    {
        ...
        reviews: "5k+",
        tag: "Personal",
        link: "https://www.amazon.com/s?k=custom+photo+puzzle",
        color: "from-amber-400/20 to-yellow-400/20 text-amber-600 dark:text-amber-300",
        icon: Puzzle
    },
    {
        id: 652,
        ...
        reviews: "15k+",
        tag: "Soothing",
        link: "https://www.amazon.com/s?k=night+light+projector+kids",
        color: "from-indigo-400/20 to-violet-400/20 text-indigo-600 dark:text-indigo-300",
        icon: Moon
    },
    {
        id: 653,
        name: "Personalized Name Blanket",
        category: "Gifts",
        price: "$35.00",
        rating: 4.8,
        reviews: "8k+",
        tag: "Custom",
        link: "https://www.amazon.com/s?k=personalized+name+blanket+kids",
        color: "from-rose-400/20 to-pink-400/20 text-rose-600 dark:text-rose-300",
        icon: Heart
    },
    {
        id: 654,
        ...
        rating: 4.7,
        reviews: "12k+",
        link: "https://www.amazon.com/s?k=kids+art+supply+kit",
        color: "from-red-400/20 to-yellow-400/20 text-red-600 dark:text-red-300",
        icon: Smile
    },
    // --- ADDITIONAL TECH ---
    {
        ...
        rating: 4.5,
        reviews: "10k+",
        link: "https://www.amazon.com/s?k=kids+smartwatch",
        color: "from-blue-400/20 to-cyan-400/20 text-blue-600 dark:text-blue-300",
        icon: Watch
    },
    {
        ...
        rating: 4.6,
        reviews: "8k+",
        link: "https://www.amazon.com/s?k=tablet+stand+for+kids",
        color: "from-gray-400/20 to-slate-400/20 text-gray-600 dark:text-gray-300",
        icon: LayoutGrid
    },
    {
        id: 662,
        name: "Bluetooth Speaker for Kids",
        category: "Tech",
        price: "$30.00",
        rating: 4.6,
        reviews: "5k+",
        link: "https://www.amazon.com/s?k=bluetooth+speaker+for+kids",
        color: "from-teal-400/20 to-emerald-400/20 text-teal-600 dark:text-teal-300",
        icon: Speaker
    },
    {
        ...
        rating: 4.5,
        reviews: "15k+",
        link: "https://www.amazon.com/s?k=digital+picture+frame",
        color: "from-amber-400/20 to-orange-400/20 text-amber-600 dark:text-amber-300",
        icon: LayoutGrid
    },
    // --- ADDITIONAL SAFETY ---
    {
        ...
        rating: 4.6,
        reviews: "20k+",
        link: "https://www.amazon.com/s?k=corner+protectors+for+kids",
        color: "from-gray-400/20 to-slate-400/20 text-gray-600 dark:text-gray-300",
        icon: Shield
    },
    {
        id: 671,
        name: "Cabinet Safety Locks",
        category: "Safety",
        price: "$15.00",
        rating: 4.7,
        reviews: "30k+",
        link: "https://www.amazon.com/s?k=cabinet+safety+locks",
        color: "from-blue-400/20 to-indigo-400/20 text-blue-600 dark:text-blue-300",
        icon: Lock
    },
    {
        id: 672,
        name: "Safety Harness Backpack",
        category: "Safety",
        price: "$20.00",
        rating: 4.5,
        reviews: "10k+",
        link: "https://www.amazon.com/s?k=toddler+harness+backpack",
        color: "from-orange-400/20 to-red-400/20 text-orange-600 dark:text-orange-300",
        icon: Heart
    },
    {
        ...
        rating: 4.7,
        reviews: "25k+",
        link: "https://www.amazon.com/s?k=non+slip+bath+mat+kids",
        color: "from-cyan-400/20 to-teal-400/20 text-cyan-600 dark:text-cyan-300",
        icon: Shield
    },
    ...
    {
        id: 680,
        name: "Emotion Cards Set",
        category: "Communication",
        price: "$15.00",
        rating: 4.7,
        reviews: "4k+",
        tag: "Feelings",
        link: "https://www.amazon.com/s?k=emotion+cards+autism",
        color: "from-pink-400/20 to-rose-400/20 text-pink-600 dark:text-pink-300",
        icon: Smile
    },
    {
        id: 681,
        name: "Choice Board Kit",
        category: "Communication",
        price: "$20.00",
        rating: 4.6,
        reviews: "2k+",
        link: "https://www.amazon.com/s?k=choice+board+autism",
        color: "from-green-400/20 to-emerald-400/20 text-green-600 dark:text-green-300",
        icon: LayoutGrid
    },
    {
        id: 682,
        name: "Token Board Set",
        category: "Communication",
        price: "$18.00",
        rating: 4.5,
        reviews: "1.5k+",
        tag: "Rewards",
        link: "https://www.amazon.com/s?k=token+board+autism",
        color: "from-yellow-400/20 to-amber-400/20 text-yellow-600 dark:text-yellow-300",
        icon: Clipboard
    },
    {
        ...
        rating: 4.6,
        reviews: "800+",
        link: "https://www.amazon.com/s?k=wait+cards+autism",
        color: "from-red-400/20 to-orange-400/20 text-red-600 dark:text-red-300",
        icon: Timer
    }
];
