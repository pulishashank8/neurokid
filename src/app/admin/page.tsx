      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Enterprise data platform management and governance
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 opacity-50 cursor-not-allowed">
              ...
              <div>
                <h3 className="font-medium text-gray-400">View Audit Logs</h3>
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 opacity-50 cursor-not-allowed">
              ...
              <div>
                <h3 className="font-medium text-gray-400">Data Quality</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Coming soon</p>
              </div>
            </div>
          </div>
